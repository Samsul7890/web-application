								...
								<div>
									<table id="dynamic-table" class="table table-striped table-bordered table-hover data">
										...
										<tbody>
											<?php
											$no = 1;
											foreach ($get_pelanggan as $key=>$value):
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs action-buttons">
															<a class="green" href="<?=base_url('Pelanggan/edit_pelanggan/'.$value['nama_pelanggan'])?>">
																<i class="ace-icon fa fa-pencil bigger-130"></i>
															</a>

															<a onclick="return confirm ('Yakin Data <?=$value['nama_pelanggan'] ?> Ingin Di Hapus.?');" class="red"  href="<?=base_url('Pelanggan/pelanggan_delete/'.$value['nama_pelanggan'])?>">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	<li>
																		<a  href="<?=base_url('Pelanggan/edit_pelanggan/'.$value['nama_pelanggan'])?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
																	...
																	<li>
																		<a onclick="return confirm ('Yakin Data <?=$value['nama_pelanggan'] ?> Ingin Di Hapus.?');" href="<?=base_url('Pelanggan/pelanggan_delete/'.$value['nama_pelanggan'])?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																			<span class="red">
